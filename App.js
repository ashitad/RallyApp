   ...
   //declaring all global variables.
    ...
    this.add(this.globalContainer);
       ...
       this.topContainer = Ext.create('Ext.container.Container',{
        ...
        //Write code for the middle container
        ...
        //Write code for the bottom/grid container
        ...
        this.globalContainer.add(this.bottomContainer);
    ...
    _createGrid: function(){
        ...
        this.globalContainer.add(this.bottomContainer);
        //console.log('Adding the grid',this.bottomContainer);
    },
